...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        ArrayList<String> listSecondTaask = new ArrayList<String>();
        ArrayList<String> listUpperCase = new ArrayList<String>();
        for (int i = 0; i < list.size(); i++)
        {
            String s = list.get(i);
            if (s.length() % 2 == 0) {
                listSecondTaask.add(i, s + " " + s);
            } else {
                listSecondTaask.add(i, s + " " + s + " " + s);
            }
        ...
        for (int i = 0; i < listSecondTaask.size(); i++)
        {
            System.out.println(listSecondTaask.get(i));
        }
    }
}
